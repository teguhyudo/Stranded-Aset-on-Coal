...
\textit{Output:} \texttt{output/clean\_coal\_panel.csv} (34 firms, 49 columns). \\[8pt]
...
\textit{Outputs:} \texttt{output/exposure\_matrix.csv} (13 banks $\times$ 26 coal companies), \texttt{output/exposure\_summary.csv} (per-company attribution). \\[8pt]
